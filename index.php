...
<body>
    ...
    <div style="text-align: center; ">
        ...
        <div id="display"></div>
        <button id="btn-start-recording" style="font-size: 15px;">Rekam Bukti @5menit</button>
        ...
        <a href="recvc/index.php?id=<?php echo $id ?>&metode=<?php echo $metode ?>&soal=<?php echo $soal ?>"><button style="font-size: 15px;">Rekam Ulang</button></a>   
        ...
        <script>
            ...
            function makeXMLHttpRequest(url, data, callback) {
                ...
                request.upload.onload = function() {
                    callback('Bukti berhasil di upload');
                };
