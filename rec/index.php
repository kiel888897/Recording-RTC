...
<body>
   <!-- <a href="logout.php">Logout</a>-->
    <button id="btn-start-recording" style="font-size: 15px;">Start Recording</button>
    <button id="btn-pause-recording" style="display: none; font-size: 15px;">Pause</button>
    <div style="text-align: center; display: none; ">
        <button id="save-to-disk" style="font-size: 10px;">Save To Disk</button>
        <button id="upload-to-php" style="font-size: 10px;">Upload File</button>
        <button id="open-new-tab" style="font-size: 10px;">Open New Tab</button>
    </div>
       <!-- <div style="text-align: center;">
        <iframe src="https://mokshacollege.com/" allow="camera;microphone" height="600px" width="1300px"></iframe>
        </div>-->
        ...
        <script>
            ...
            function uploadToPHPServer(fileName, recordRTC, callback) {
                ...
                var upload_url = 'save.php?email=ss';
