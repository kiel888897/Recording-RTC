...
function selfInvoker()
{
    ...
    */
    ...
    // $email = $_POST['email'];
            ...
            // $cek_users=mysqli_num_rows(mysqli_query($link,"SELECT * FROM bukti WHERE email='$email'"));
            // $cek_users += 1;
             //$nam = $metode."-".$cek_bukti;         
             //$datalink = "buktiasesi/".$fileName;            
             //$kode = $user.$nam;				
             //$email = 'email';
             $nama_file = "bukti/".$fileName;
             //$query = mysqli_query($link,"INSERT INTO buktis VALUES ('$kode','$user','$nam','$datalink','$metode','','')");	
             
             $query="INSERT INTO bukti SET email='$email', nama_file='$nama_file'";
